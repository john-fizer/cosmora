...
function getTechniques(type: ReportType, chartContext: string, birthYear: number): Technique[] {
  ...
  const map: Record<ReportType, Technique[]> = {
    ...
    life_pivots: [
      ...
      { id: "pivotal_synthesis", label: "The Turning Point", areaOfLife: "Integration", prompt: `${base}\n\nSynthesize the current pivotal themes for this native. The "loosening of bonds" in traditional Hellenistic astrology refers to moments when the current timing period (L2 in Zodiacal Releasing) falls in the 7th sign from the L1 major period — an opposition that marks major life restructuring, the release of old obligations, and fundamental repositioning of the soul's direction. Whether or not that technical trigger is active, identify: which life structures are being outgrown right now, what is genuinely asking to be released versus what is worth consolidating, and what the progressed and transit picture suggests is being born next. Write with the precision of someone who has watched this pattern play out many times. 3 paragraphs.` },
    ],
    ...
    progressed_planets: [
      { id: "prog_sun", label: "Progressed Sun", areaOfLife: "Identity Evolution", prompt: `${base}\n\nSecondary progressions use the day-for-a-year method: the ${age}th day after birth is the progressed chart for this native at age ${age}. The progressed Sun moves ~1° per year. Analyze what sign the progressed Sun is currently in (or approaching), what house it has progressed into, and what progressed Sun aspects are forming or exact. What chapter of identity is this person in? How is the self-definition shifting from the natal Sun? 3–4 paragraphs.` },
      { id: "prog_moon", label: "Progressed Moon", areaOfLife: "Emotional Seasons", prompt: `${base}\n\nThe progressed Moon moves approximately 1° per month — one sign every ~2.5 years. For this native at age ${age}, analyze: what sign and house the progressed Moon has reached, what the current progressed lunar phase is (new, waxing, full, waning — relative to progressed Sun), and what emotional season this represents. The progressed Moon is the most active personal timer in progressions. 3–4 paragraphs.` },
      { id: "prog_ingresses", label: "Sign Ingresses & Stations", areaOfLife: "Pivotal Shifts", prompt: `${base}\n\nFor this native at age ${age}: which inner planets (Mercury, Venus, Mars, and especially the Sun and Moon) have progressed into new signs since birth? Any progressed planets turning retrograde or stationing direct? Sign ingresses and stations are among the most significant progressed events — they mark long-term shifts in how a planet expresses itself. Identify the 2–3 most significant ingresses or stations for this native's current life phase. 3–4 paragraphs.` },
      { id: "prog_aspects", label: "Key Progressed Aspects", areaOfLife: "Active Activations", prompt: `${base}\n\nFor this native at age ${age}: what are the most significant progressed-to-natal aspects currently within orb (1° applying or separating)? Focus on: progressed Sun or Moon aspecting natal planets, progressed Venus or Mars making significant contacts, and progressed angles (ASC/MC). Each aspect describes a period of activation that can last years. What are the 2–3 most active progressed aspects right now and what do they signify? 3–4 paragraphs.` },
      { id: "prog_synthesis", label: "The Current Life Chapter", areaOfLife: "Integration", prompt: `${base}\n\nSynthesize the progressed picture for this native at age ${age}. The progressed chart is not a separate chart but the natal chart evolving in real time — inner planets shift sign, the Moon tracks emotional seasons, angles accumulate degree changes. What single life chapter do the progressions together describe? What is the underlying developmental arc right now, and what is the progressed chart asking this person to embody or release? 3 paragraphs.` },
    ],
  };
